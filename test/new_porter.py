...
class modified_button(tk.Button):
    ...
    def changebg(self, a, event):
        global g, l, q, type
        if self[
            "bg"] != "#80bfff" and a == "leave" and l != 0:  # if the bg of the color is not dark blue change the bg to white
...
class explorer(tk.Frame):
    def __init__(self, root, *args, **kwargs):
        ...
        self.window = root
        self.lst = []
        self.starting_path = "C:"
        self.z = " "
        self.last_search = ""
        self.val = [0, 0, 0, 1, 0, 1, 0, 0, 1, 0]
        self.p1 = ImageTk.PhotoImage(file="img/dir.png")
        self.p2 = ImageTk.PhotoImage(file="img/documents.png")
        self.back = ImageTk.PhotoImage(Image.open("img/back.png").resize((50, 50), Image.ANTIALIAS))
        self.forward = ImageTk.PhotoImage(Image.open("img/un-select.png").resize((50, 50), Image.ANTIALIAS))
        self.no_of_files = 0
    ...
    def create_basics(self, a):
        ...
        self.back_button = modified_button(self.navigation_buttons, type="other", image=self.back, borderwidth=0,
                                           bg="#ffffff")
        self.forward_button = modified_button(self.navigation_buttons, type="other", image=self.forward, borderwidth=0,
                                              bg="#ffffff")
...
if __name__ == "__main__":  # creating basic window
    ...
    window.iconbitmap("img/app_icon.png")
    x = explorer(window)
    x.create_basics("")
